    ...
    <div style={{ padding:'16px 20px 16px',maxWidth:500,margin:'0 auto' }}>
      <div style={{ background:S.white,border:`0.5px solid ${isFounding(userTier)?'#E6C99A':S.border}`,borderRadius:18,padding:'16px',marginBottom:14,position:'relative',overflow:'hidden' }}>
        ...
        <div style={{ display:'flex',alignItems:'center',justifyContent:'space-between',marginBottom:12 }}>
          <div style={{ display:'flex',alignItems:'center' }}><p style={{ fontFamily:"'Lora',serif",fontSize:15,fontWeight:500,color:S.forest,margin:0 }}>My Calendar</p><InfoTip label="How the calendar works" placement="bottom" text={"Tap a day to open it for meals, then choose breakfast, lunch, or dinner. Tap an open day again to close it, or drag across days to open several at once. Today — and after 6pm, tomorrow — can't be opened, since your village needs a little notice to send a meal. You can clear any open days your village hasn't claimed yet."}/></div>
